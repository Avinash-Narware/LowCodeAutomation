...
import org.testng.annotations.Test;
	...
	public class EmailUtilsAPI extends ApiUtils {
	...
	//	
		public static String[] to ={"santhoshi@novopay.in"};
			//
		...
		public void emailSummaryReport() {
			...
			try {
				...
				String subject = " CBS API Automation Test Execution Status :Sanity for Price Master,Price Setup,Tax Component,Tax Group "+configProperties.get("buildNumber")+" : " + getTodaysDate("dd MMMM yyyy");
				String bodyText = "Hi All,\n\nPFA CBS API Automation Execution report.\n\nRegards,\nNovopay Automation Team\n\n---This is an auto-generated email, Please do not reply to this.<br/><br/><br/>"
						+ utils.report();
